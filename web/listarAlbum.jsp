    ...
    <body class="bg-black bg-gradient">
        <div class="container text-light">
            ...
            <table class="table table-stripped mt-3 text-light bg-secondary bg-opacity-25">
                <tr class="bg-success"><th>Código</th><th>Nombre</th><th>Artista</th><th>Año</th><th>CodDiscog</th><th>Modificaciones</th></tr>
                <!--grabar filas-->
                ...
                <%
                    while (listado.next()) {
                        ...
                        out.println("<td>" + listado.getString("CodDiscog") + "</td>");
                %>
