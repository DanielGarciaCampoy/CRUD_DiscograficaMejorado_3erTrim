    ...
    <body class="bg-black bg-gradient">
        <div class="container text-light">
            ...
            <%
                ...
                ResultSet listadoDiscog = s1.executeQuery ("SELECT * FROM discografica");
                ResultSet listadoDiscog1 = s2.executeQuery ("SELECT * FROM discografica");
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top">
                <div class="container-fluid">
                  <a class="navbar-brand" href="logout.jsp"><img src="img/person.png" width="40"/>Cerrar sesión</a>
            ...
            <table class="table table-stripped mt-3 text-light bg-secondary bg-opacity-25">
                <tr class="bg-success"><th>Código</th><th>Nombre</th><th>Artista</th><th>Año</th><th>Discog.Asociada</th><th>Modificaciones</th></tr>
                <!--grabar filas-->
                <form method="get" action="grabaAlbum.jsp">
                    <tr>
                        ...
                        <!--<td><input type="text" name="CodDiscog" class="form-control" size="1"></td><!--<option value=""></option> desplegable con los nombres-->
                        <td>
                            <select class="form-select" id="discog" name="CodDiscog">
                            <%
                                while (listadoDiscog.next()) {
                                    %><option value="<%=listadoDiscog.getString("CodDiscog")%>"><%=listadoDiscog.getString("NomDiscog")%></option><%
                                }
                            %>
                            </select>
                        </td>
                ...
                <!--listado-->
                <%
                    while (listado.next() && listadoDiscog1.next()) {
                        out.println("<tr><td>");
                        ...
                        out.println("<td>" + listadoDiscog1.getString("NomDiscog") + "</td>");
                %>
