...
<html>
    ...
    <body class="bg-dark">
        ...
        <%
            ...
            ResultSet listadoDiscog = s1.executeQuery ("SELECT NomDiscog FROM discografica WHERE CodDiscog = " + request.getParameter("CodDiscog"));
            listadoDiscog.next();
        ...
        <div class="login-page">
            <div class="form">
                ...
                <form class="login-form text-start" method="get" action="grabaAlbumModificado.jsp">
                    ...
                    <label>Discog.ASOCIADA</label><input name="CodDiscog" type="text" value="<%=listadoDiscog.getString("NomDiscog")%>" readonly/>
                    <p class="message">No se puede cambiar el código del propio álbum ni el de la discográfica asociada</p>
