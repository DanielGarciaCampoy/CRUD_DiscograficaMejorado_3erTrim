        ...
        <div class="login-page">
            <div class="form">
                ...
                <form class="login-form text-start" method="get" action="grabaDiscogModificado.jsp">
                    <label>CodAlbum</label><input name="CodDiscog" type="text" value="<%=request.getParameter("CodDiscog")%>" readonly/>
                    <label>NomAlbum</label><input name="NomDiscog" type="text" value="<%=request.getParameter("NomDiscog")%>"/>
                    <p class="message">No se puede cambiar el código</p>
                    <button type="submit">Modificar</button>
                    <a class="btn btn-danger" href="../listarDiscog.jsp">Cancelar</a>
                </form>
            </div>
        </div>
