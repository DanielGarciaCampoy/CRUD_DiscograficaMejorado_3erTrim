...
<html>
    ...
    <body class="bg-dark">
        <%
            ...
            String actualizacion = "UPDATE discografica SET "
                                + "NomDiscog='" + request.getParameter("NomDiscog")
                                + "' WHERE CodDiscog = " + request.getParameter("CodDiscog");
            
            s.execute(actualizacion);
        %>
        <div class="login-page">
            <div class="form">
                <h2>Se ha actualizado su discográfica correctamente:</h2>
