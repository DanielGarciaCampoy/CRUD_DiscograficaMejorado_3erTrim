...
CREATE TABLE IF NOT EXISTS `album` (
    ...
    `CodDiscog` int(11) NOT NULL, -- FK 
    
    PRIMARY KEY (`CodAlbum`),
    FOREIGN KEY (`CodDiscog`) REFERENCES discografica (`CodDiscog`) 
...
INSERT INTO `album` (`CodAlbum`, `NomAlbum`, `NomArtista`, `AnoLanzamiento`, `CodDiscog`) VALUES
(1, 'album1', 'artista1', 1111, 1);
